...
#+begin_src haskell
  ...
  -- Infer doctype via type system:
  Ok _ jsonResponse parsedResponse <- ERPNext.Client.getDoc @DocType manager config "Task"

  -- Explicitly name the doctype to fetch:
  Ok _ jsonResponse2 _ <- ERPNext.Client.Simple.getDoc manager config "DocType" "Task"
#+end_src
